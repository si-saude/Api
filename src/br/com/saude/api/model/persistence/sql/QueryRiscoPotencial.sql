SELECT rp.id as id, get_valor_risco_potencial( rp.id ) as valor,
	...
	get_pendencia_encerramento_risco_potencial_equipe(rp.id, [EQUIPE_ID]) as pendenciaEncerramento,
	get_pendencia_validacao_risco_potencial(rp.id) as pendenciaValidacao,
	get_pendencia_reavaliacao_risco_potencial_equipe(rp.id, [EQUIPE_ID]) as pendenciaReavaliacao
