...
@Path("cidade")
@RequestInterceptor
public class CidadeService extends GenericServiceImpl<Cidade, CidadeFilter, CidadeBo>
							implements GenericService<Cidade, CidadeFilter> {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(CidadeFilter filter) throws InstantiationException, IllegalAccessException,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(CidadeFilter filter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, Exception {
