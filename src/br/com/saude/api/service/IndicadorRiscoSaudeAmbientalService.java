...
public class IndicadorRiscoSaudeAmbientalService {
	...
	public Response getList(IndicadorRiscoFilter filter) throws Exception {
		return Response.ok(IndicadorRiscoSaudeAmbientalBo.getInstance()
	...
	public Response getSelectList(IndicadorRiscoFilter filter) throws Exception {
		return Response.ok(IndicadorRiscoSaudeAmbientalBo.getInstance().getSelectList(filter)).build();
	}
	
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response get(@QueryParam("id") int id) throws Exception{
		return Response.ok(IndicadorRiscoSaudeAmbientalBo.getInstance().getById(id)).build();
	}
	...
	public Response delete(int id) {
		try {
			IndicadorRiscoSaudeAmbientalBo.getInstance().delete(id);
