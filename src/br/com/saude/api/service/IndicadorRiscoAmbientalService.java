...
public class IndicadorRiscoAmbientalService {
	...
	public Response getList(IndicadorRiscoFilter filter) throws Exception {
		return Response.ok(IndicadorRiscoAmbientalBo.getInstance()
	...
	public Response getSelectList(IndicadorRiscoFilter filter) throws Exception {
		return Response.ok(IndicadorRiscoAmbientalBo.getInstance().getSelectList(filter)).build();
	}
	
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response get(@QueryParam("id") int id) throws Exception{
		return Response.ok(IndicadorRiscoAmbientalBo.getInstance().getById(id)).build();
	}
	...
	public Response delete(int id) {
		try {
			IndicadorRiscoAmbientalBo.getInstance().delete(id);
