...
public class CriterioService 
	...
	@Override
	protected CriterioBo getBo() {
		return CriterioBo.getInstance();
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(CriterioFilter filter) throws InstantiationException, IllegalAccessException,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(CriterioFilter filter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, Exception {
