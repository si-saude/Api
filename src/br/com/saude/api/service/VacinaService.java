...
@Path("vacina")
@RequestInterceptor
public class VacinaService extends GenericServiceImpl<Vacina,VacinaFilter,VacinaBo>
							implements GenericService<Vacina,VacinaFilter>{
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(VacinaFilter filter) throws InstantiationException, IllegalAccessException,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(VacinaFilter filter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, Exception {
