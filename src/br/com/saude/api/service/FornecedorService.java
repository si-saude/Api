...
@Path("fornecedor")
@RequestInterceptor
public class FornecedorService extends GenericServiceImpl<Fornecedor,FornecedorFilter,FornecedorBo>
								implements GenericService<Fornecedor,FornecedorFilter>{
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(FornecedorFilter filter) throws InstantiationException, IllegalAccessException,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(FornecedorFilter filter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, Exception {
