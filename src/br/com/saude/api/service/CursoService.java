...
@Path("curso")
@RequestInterceptor
public class CursoService extends GenericServiceImpl<Curso,CursoFilter,CursoBo>
							implements GenericService<Curso,CursoFilter>{
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(CursoFilter filter) throws InstantiationException, IllegalAccessException,
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(CursoFilter filter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, Exception {
